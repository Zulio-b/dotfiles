...
hl.window_rule({ name = "tag-multimedia-streaming",    match = { class = "^(com.stremio.stremio|com-nuvio-app-MainKt)$" }, tag = "+multimedia" })
hl.window_rule({ name = "tag-multimedia-mpv",    match = { class = "^(mpv)$" }, tag = "+multimedia" })
